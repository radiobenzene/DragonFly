...
public class StaticShader extends ShaderProgram{
	...
	private static final String VERTEX_FILE = "src/entityRenderer/vertexShader.txt"; //Path to Vertex Shader
	private static final String FRAGMENT_FILE = "src/entityRenderer/fragmentShader.txt"; //Path to Fragment Shader
